...
import sub from "../../components/pictures/sub.PNG"
import seen from "../../components/pictures/seen.PNG"
import chats from "../../components/pictures/chats.PNG"
    ...
    render() {
        return (
            <div className="user">
                ...
                <div className="pic">
                    <img className="ico" src={this.state.arr1.profileImageUrl}/>
